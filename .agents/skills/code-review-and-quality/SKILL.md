...
description: Conducts multi-axis code review. Use before merging any change. Use when reviewing code written by yourself, another agent, or a human. Use when you need to assess code quality across multiple dimensions before it enters the main branch. Use whenever the user asks to "auditar el sistema", "revisar código", or evaluate code quality.
---
...
- When the user asks to "auditar el sistema", "revisar bugs", or "revisar calidad de código"
